...
<table><tr><td>All platforms:</td>
    <td>
      <a href="https://dev.azure.com/conda-forge/feedstock-builds/_build/latest?definitionId=3678&branchName=master">
        <img src="https://dev.azure.com/conda-forge/feedstock-builds/_apis/build/status/beem-feedstock?branchName=master">
      </a>
    </td>
  </tr>
</table>
...
It is possible to list all of the versions of `beem` available on your platform with:

```
conda search beem --channel conda-forge
```
...
Updating beem-feedstock
=======================

If you would like to improve the beem recipe or build a new
...
Note that all branches in the conda-forge/beem-feedstock are
